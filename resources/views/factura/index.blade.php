										...
										<tr>
											...
											<td>
												<div class='btn-group  btn-group-sm' role='group' aria-label='...'>
													...
													@if($factura->estado != 'E')<a class='btn btn-success' href='{{action('FacturaController@exonerate', [$factura->id])}}'><span class='glyphicon glyphicon-piggy-bank'></span></a> @endif
...
<script>
	$(document).ready(function() {
		$('#show-modal').on('show.bs.modal', function(e) {
			...
			var modulo = $(e.relatedTarget).data("modulo")
			$('#show-modal .modal-body').html("Cargando...")
				.load("../" + modulo + "/factura/" + id,
					function() {
